module.exports = {
  OWNER_IDS: ["805922872543543297"], // Bot owner ID's
  SUPPORT_SERVER: "1316086163924193341", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  MUSIC: {
    ...
    DEFAULT_SOURCE: "YT", // YT = Youtube, YTM = Youtube Music, SC = SoundCloud (using YT for best compatibility)
