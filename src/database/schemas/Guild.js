...
const Schema = new mongoose.Schema({
  ...
  msglog_channel: String,
  memberlog_channel: String,
  logs: {
    bans: { type: Boolean, default: false },
    kicks: { type: Boolean, default: false },
    warns: { type: Boolean, default: false },
    deletes: { type: Boolean, default: false },
  ...
  verification: {
    ...
    channel: String,
    role: String,
    message: { type: String, default: "Welcome! Please click the button below to verify." },
    button_text: { type: String, default: "Verify" },
    min_age: { type: Number, default: 0 },
    require_avatar: { type: Boolean, default: false },
